...
Alcohol_Out %>%
  plot_trends() +
  labs(title="Synthetic and Observed Rate of Alcohol Admissions",
       y="Log Alcohol Admission Rate",
       x="Year")
ggsave(here("Figures/Figure_Trend_Alcohol.png"))

Alcohol_Out %>%
  plot_differences() +
  labs(title="Difference between Synthetic and Observed",
       y="Difference in Log Alcohol Admission Rate",
       x="Year")
ggsave(here("Figures/Figure_Difference_Alcohol.png"))

Alcohol_Out %>%
  plot_mspe_ratio() +
  labs(title="Ratio of Pre/Post Treatment Mean Squared Prediction Error (Alcohol)",
       x="State FIPS, ordered")
ggsave(here("Figures/Figure_MSPERat_Alcohol.png"))